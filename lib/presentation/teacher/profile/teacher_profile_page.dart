        ...
        child: Column(
          children: [
            ...
            if (profile.course != null) ...[
              ...
              ProfileInfoCard(
                title: 'Course',
                value: profile.course!.courseName,
                icon: Icons.book,
              ),
              SizedBox(height: 12.h),
              ProfileInfoCard(
                title: 'Period',
                value: '${DateFormat('MMM y').format(profile.course!.startDate)} - ${DateFormat('MMM y').format(profile.course!.endDate)}',
            ...
            if (profile.classes.isNotEmpty) ...[
              ...
              Align(
                ...
                child: Text('Classes', style: TextStyle(fontSize: 16.sp, fontWeight: FontWeight.w600)),
              ),
              SizedBox(height: 12.h),
              ...profile.classes.map(
                (e) => Padding(
                  ...
                  child: Container(
                    ...
                    child: Column(
                      ...
                      children: [
                        Text(e.name, style: TextStyle(fontSize: 16.sp, fontWeight: FontWeight.w600)),
                        Text(e.courseName, style: TextStyle(fontSize: 14.sp, color: AppColors.black500)),
                        Text(e.number, style: TextStyle(fontSize: 12.sp, color: AppColors.black300)),
                      ],
                    ),
                  ),
                ),
