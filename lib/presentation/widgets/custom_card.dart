...
class CustomCard extends StatelessWidget {
  const CustomCard({super.key, required this.asset,  this.value, this.label,this.top,required this.color});
final String asset;
 final String? value;
   final String? label;
   final double? top;
  ...
  Widget build(BuildContext context) {
    return  Container(
      ...
      decoration: BoxDecoration(
        ...
        boxShadow: [BoxShadow(color: Colors.black26, blurRadius: 2.r, offset: Offset(0, 4.h))],
      ),
      child: Padding(
